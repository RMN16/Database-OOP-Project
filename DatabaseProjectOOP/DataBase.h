...
public:
    ...
    int findTableIndex(const std::string& tableName);
    ...
    void Myexport(const std::string& name, const std::string& filename);
    ...
    void addColumn(const std::string& tableName, const std::string& name, const DataType& type);
